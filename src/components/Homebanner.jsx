			...
			<div className="banner">
				<div className="container">
					<div className="banner_content flex flex-col justify-end flex-nowrap min-h-screen pb-[100px]">
						<p className="flex flex-row flex-wrap items-center justify-start gap-3 mb-6 text-18 font-inter font-light dark:text-white text-raven fadeInUpHead">
						...
						<h1 className="m-0 font-oswald text-h1 uppercase dark:text-white text-raven fadeInUp">
